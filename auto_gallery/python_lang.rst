...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'Marge', 'Maggie', 'Homer', 'Lisa', 'Bart'}

    [['Marge', 43, 'mother'], ['Maggie', 1, 'daughter'], ['Homer', 45, 'father'], ['Lisa', 10, 'daughter'], ['Bart', 11, 'son']]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'Marge': ['mother', 43], 'Maggie': ['daughter', 1], 'Homer': ['father', 45], 'Lisa': ['daughter', 10], 'Bart': ['son', 11]}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    {'gall': 1, 'too': 2, 'if': 2, 'stumble': 1, 'our': 2, 'but': 1, 'large': 1, 'like': 1, 'are': 1, 'us': 2, 'cause': 1, 'pinch': 1, 'to': 2, 'incomes': 1, 'they': 2, 'small': 1, 'and': 2, 'shoes;': 1, 'trip': 1, 'Tick-tow': 1}
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Join: [['Marge', 'mother', 43], ['Homer', 'father', 45], ['Bart', 'son', 11]]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Sequential execution, elapsed time: 2.1623544692993164
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Concurrent execution with threads, elapsed time: 1.1997947692871094
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Concurrent execution with processes, elapsed time: 0.9728977680206299
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Balanced Accuracy: 0.65
    Concurrent execution with processes, elapsed time: 3.1009037494659424
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    ('/tmp/README2.md', <email.message.Message object at 0x7ce0a7d94650>)
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 14.474 seconds)
